...
@router.post("/bitcoin")
def bitcoin(request: BitcoinRequest, truss_controller: truss = Depends(get_truss_controller)) -> dict:
...
@router.post("/glow")
def glow_effect(request: GlowRequest, truss_controller: truss = Depends(get_truss_controller)) -> dict:
...
@router.post("/wave")
def wave_effect(request: WaveRequest, truss_controller: truss = Depends(get_truss_controller)) -> dict:
...
def color_wipe_effect(request: ColorWipeRequest, truss_controller: truss = Depends(get_truss_controller)) -> dict:
...
def color_fade_effect(request: ColorFadeRequest, truss_controller: truss = Depends(get_truss_controller)) -> dict:
...
@router.post("/sparkle")
def sparkle_effect(request: SparkleRequest, truss_controller: truss = Depends(get_truss_controller)) -> dict:
...
@router.post("/rainbow")
def rainbow_effect(request: RainbowRequest, truss_controller: truss = Depends(get_truss_controller)) -> dict:
...
def rainbow_cycle_effect(request: RainbowCycleRequest, truss_controller: truss = Depends(get_truss_controller)) -> dict:
...
def theater_chase_effect(request: TheaterChaseRequest, truss_controller: truss = Depends(get_truss_controller)) -> dict:
...
@router.post("/running")
def running_effect(request: RunningRequest, truss_controller: truss = Depends(get_truss_controller)) -> dict:
...
def heart_rate_effect(request: HeartRateRequest, truss_controller: truss = Depends(get_truss_controller)) -> dict:
